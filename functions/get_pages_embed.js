module.exports = {
    ...
    async execute(settings, message, args, title, image_url, fields_function, info_file) {


        let pages_template = require('./get_pages_template.js')
        ...
        let page = 0
        let fields = fields_function(info_file, settings.config)
