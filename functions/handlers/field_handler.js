module.exports = {
    execute(settings, info_file, field_function_file_name, has_pages, embed_size_type) {
        ...
        function check_field_index(counter){
            ...
            field_index = Math.floor(counter/settings.config['embed_sizes'][embed_size_type])
